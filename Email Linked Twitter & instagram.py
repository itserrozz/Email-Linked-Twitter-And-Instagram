...
def iglinkedcheck():
   try:
       ...
       iglinkedcheck()
def log():
    print(f"""{Fore.GREEN}  ______                 _ _   _      _       _            _                                     
 |  ____|               (_) | | |    (_)     | |          | |                                    
 | |__   _ __ ___   __ _ _| | | |     _ _ __ | | _____  __| |                                    
 |  __| | '_ ` _ \ / _` | | | | |    | | '_ \| |/ / _ \/ _` |                                    
 | |____| | | | | | (_| | | | | |____| | | | |   <  __/ (_| |                                    
 |______|_| |_| |_|\__,_|_|_| |______|_|_| |_|_|\_\___|\__,_|                                    
  _______       _ _   _                       _____           _                                  
 |__   __|     (_) | | |              ___    |_   _|         | |                                 
    | |_      ___| |_| |_ ___ _ __   ( _ )     | |  _ __  ___| |_ __ _  __ _ _ __ __ _ _ __ ___  
    | \ \ /\ / / | __| __/ _ \ '__|  / _ \/\   | | | '_ \/ __| __/ _` |/ _` | '__/ _` | '_ ` _ \ 
    | |\ V  V /| | |_| ||  __/ |    | (_>  <  _| |_| | | \__ \ || (_| | (_| | | | (_| | | | | | |
    |_| \_/\_/ |_|\__|\__\___|_|     \___/\/ |_____|_| |_|___/\__\__,_|\__, |_|  \__,_|_| |_| |_|
                                                                        __/ |                    
                                                                       |___/                    
                                     --> Codded By @404.erroz <--\n---------------------------------------------------------------------------------------------------------------             """)
